  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        sand: { DEFAULT: "hsl(var(--sand))", light: "hsl(var(--sand-light))" },
        clay: { DEFAULT: "hsl(var(--clay))", light: "hsl(var(--clay-light))" },
        ocean: { DEFAULT: "hsl(var(--ocean))", light: "hsl(var(--ocean-light))" },
        plum: { DEFAULT: "hsl(var(--plum))", light: "hsl(var(--plum-light))" },
